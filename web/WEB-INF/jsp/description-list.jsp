...
<div class="container">
<c:forEach var="description" items="${requestScope.description}">
    <p class="text-center"><a href="${pageContext.request.contextPath}/description-info?id=${description.id}">${description.name}</a></p>
</c:forEach>
</div>
</body>
</html>